  ...
  actions: {
    ...
    async setup(id: number) {
      ...
      if (this.setuped == false) {
        ...
        //this.socket.in("userStatus").emit("connectionStatus", id);
        ...
        this.socket.on("newChallenge", (challenge: Challenge) => {
          if (this.challenge != null) {
            ...
            //this.socket.in("userStatus").emit("alreadyChallenged");
          } else {
    ...
    challengeUser(id: Number, level: Number, challenged: Number) {
      ...
      if (el) {
        ...
        //this.socket.in("userStatus").emit("newChallenge", challenge);
      }
    },
    ...
    changeCurrentUserStatus(newStatus: status, id: Number) {
      ...
      if (el) {
        ...
        //this.socket.in("userStatus").emit("changeStatus", el);
      }
    },
  },
});
