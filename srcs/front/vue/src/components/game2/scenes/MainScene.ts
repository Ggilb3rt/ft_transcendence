...
import astronaut from "../assets/spritesheets/astronaut3.png";
import mainroom from "../assets/backgrounds/mainroom.png";
import vendingmachine from "../assets/sprites/vendingMachine.png"
...
export default class MainScene extends Phaser.Scene {
  ...
  preload() {
    this.load.spritesheet("astronaut", astronaut, {
      frameWidth: 29,
      frameHeight: 37,
    });
    this.load.image("vendingMachine", vendingmachine);
    this.load.image("mainroom", mainroom);
  }
